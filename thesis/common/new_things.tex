...
\lstdefinestyle{tcl}{
    ...
    showtabs=false,                  
    tabsize=2,
    morekeywords={*, create_pblock, get_pblocks, add_cells_to_pblock, get_cells, resize_pblock, set_property, open_run, write_bitstream, get_designs, create_ip, generate_target, get_ips, get_files},
