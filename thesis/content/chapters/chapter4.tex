...
GCC (the C compiler used by Vitis) allows to define the linker script like the showed one. It allows to force the placement of a certain variable in a certain section. This can be done as follows:
