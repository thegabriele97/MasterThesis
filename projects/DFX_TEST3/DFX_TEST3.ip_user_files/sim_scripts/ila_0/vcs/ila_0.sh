...
#
# Generated by Vivado on Thu May 05 09:50:51 CEST 2022
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../DFX_TEST3.gen/sources_1/ip/ila_0/hdl/verilog" +incdir+"/mnt/Volume/PopOSFiles/Vivado/Vivado/2021.1/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../DFX_TEST3.gen/sources_1/ip/ila_0/hdl/verilog" +incdir+"/mnt/Volume/PopOSFiles/Vivado/Vivado/2021.1/data/xilinx_vip/include" \
  ...
  vhdlan -work xil_defaultlib $vhdlan_opts \
    "$ref_dir/../../../../DFX_TEST3.gen/sources_1/ip/ila_0/sim/ila_0.vhd" \
  2>&1 | tee -a vhdlan.log
...
create_lib_mappings()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/home/gabriele97/Repos/MasterThesis/projects/DFX_TEST3/DFX_TEST3.cache/compile_simlib/vcs"
  fi
