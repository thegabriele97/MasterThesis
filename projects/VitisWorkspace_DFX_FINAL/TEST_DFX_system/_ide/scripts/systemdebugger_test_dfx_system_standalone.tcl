...
fpga -file /home/gabriele97/Repos/MasterThesis/projects/VitisWorkspace_DFX_FINAL/TEST_DFX_ARM/_ide/bitstream/design_1.bit
targets -set -nocase -filter {name =~"APU*"}
...
targets -set -nocase -filter {name =~"APU*"}
source /home/gabriele97/Repos/MasterThesis/projects/VitisWorkspace_DFX_FINAL/TEST_DFX_ARM/_ide/psinit/ps7_init.tcl
ps7_init
ps7_post_config
configparams mdm-detect-bscan-mask 2
targets -set -nocase -filter {name =~ "*microblaze*#0" && bscan=="USER2" }
dow /home/gabriele97/Repos/MasterThesis/projects/VitisWorkspace_DFX_FINAL/TEST_DFX_UBLAZE/Debug/TEST_DFX_UBLAZE.elf
targets -set -nocase -filter {name =~ "*A9*#0"}
dow /home/gabriele97/Repos/MasterThesis/projects/VitisWorkspace_DFX_FINAL/TEST_DFX_ARM/Debug/TEST_DFX_ARM.elf
