...
#
# Generated by export_simulation on Wed May 11 16:26:40 CEST 2022
#
################################################################################
...
./design_1_ilmb_bram_if_cntlr_0.sh
...
'-reset_run' switch to the './design_1_ilmb_bram_if_cntlr_0.sh' script.

./design_1_ilmb_bram_if_cntlr_0.sh -reset_run
...
./design_1_ilmb_bram_if_cntlr_0.sh -noclean_files

For more information on the script, please type './design_1_ilmb_bram_if_cntlr_0.sh -help'.
