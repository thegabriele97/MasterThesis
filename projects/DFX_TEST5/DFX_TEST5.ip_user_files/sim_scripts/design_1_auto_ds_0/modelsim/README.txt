...
#
# Generated by export_simulation on Thu May 12 17:42:41 CEST 2022
#
################################################################################
...
'-reset_run' switch to the './design_1_auto_ds_0.sh' script.

./design_1_auto_ds_0.sh -reset_run
...
./design_1_auto_ds_0.sh -noclean_files

For more information on the script, please type './design_1_auto_ds_0.sh -help'.
