...
#
# Generated by export_simulation on Fri Apr 22 16:38:35 CEST 2022
#
################################################################################
...
'-reset_run' switch to the './CNT_MOD16_0.sh' script.

./CNT_MOD16_0.sh -reset_run
...
./CNT_MOD16_0.sh -noclean_files

For more information on the script, please type './CNT_MOD16_0.sh -help'.
