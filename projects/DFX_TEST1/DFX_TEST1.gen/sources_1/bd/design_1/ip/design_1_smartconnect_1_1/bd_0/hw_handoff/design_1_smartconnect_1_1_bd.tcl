...
################################################################
# This is a generated script based on design: bd_483c
#
...
proc create_hier_cell_m00_exit_pipeline { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.SSC008_ROUTE {0b1001} \
   CONFIG.SSC009_ROUTE {0b1001} \
   CONFIG.SSC010_ROUTE {0b1001} \
   CONFIG.SSC011_ROUTE {0b1001} \
   CONFIG.SSC012_ROUTE {0b1011} \
   CONFIG.SSC013_ROUTE {0b1001} \
   CONFIG.SSC014_ROUTE {0b1001} \
   CONFIG.SSC015_ROUTE {0b1001} \
