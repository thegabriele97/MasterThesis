...
proc create_root_design { parentCell } {
  ...
  set rp_CNTMOD_B2R [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 rp_CNTMOD_B2R ]
  set_property -dict [ list \
  ...
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {rp_CNTMOD_B2R} \
 ] $CLK
  set ICAP_DBG_CSIB [ create_bd_port -dir I ICAP_DBG_CSIB ]
  set ICAP_DBG_I [ create_bd_port -dir I -from 31 -to 0 ICAP_DBG_I ]
  set ICAP_DBG_O [ create_bd_port -dir I -from 31 -to 0 ICAP_DBG_O ]
  set ICAP_DBG_RDWRB [ create_bd_port -dir I ICAP_DBG_RDWRB ]
  set VS0_error [ create_bd_port -dir O VS0_error ]
  set VS0_reset [ create_bd_port -dir O VS0_reset ]
  set VS0_trigger [ create_bd_port -dir I -from 1 -to 0 VS0_trigger ]
...
CDC_STAGES 6 VS {VS_0 {ID 0 NAME VS_0 RM {cnt_mod4 {ID 0 NAME cnt_mod4 BS {0\
{ID 0 ADDR 268435456 SIZE 117560 CLEAR 0}} RESET_REQUIRED low} cnt_mod16 {ID 1\
NAME cnt_mod16 BS {0 {ID 0 ADDR 268553016 SIZE 117560 CLEAR 0}} RESET_REQUIRED\
low}} POR_RM cnt_mod4 NUM_HW_TRIGGERS 2 NUM_TRIGGERS_ALLOCATED 2\
HAS_AXIS_STATUS 0 HAS_POR_RM 1 START_IN_SHUTDOWN 0 RMS_ALLOCATED 2\
HAS_AXIS_CONTROL 0 SKIP_RM_STARTUP_AFTER_RESET 1}} CP_FAMILY 7series DIRTY 3}\
   CONFIG.GUI_BS_ADDRESS_0 {0x1001CB38} \
   CONFIG.GUI_BS_SIZE_0 {117560} \
   CONFIG.GUI_RESET_ACTIVE_LEVEL {0} \
   CONFIG.GUI_RM_NEW_NAME {cnt_mod16} \
  ...
  set_property -dict [ list \
   CONFIG.ALL_PARAMS {INTF {CNTMOD_B2R {ID 0 VLNV xilinx.com:interface:aximm_rtl:1.0 PROTOCOL\
...
WIDTH 1} WVALID {PRESENT 1 WIDTH 1} WREADY {PRESENT 1 WIDTH 1} AWADDR {PRESENT\
1 WIDTH 32} AWLEN {PRESENT 0 WIDTH 8} AWSIZE {PRESENT 0 WIDTH 3} AWBURST\
{PRESENT 0 WIDTH 2} AWLOCK {PRESENT 0 WIDTH 1} AWCACHE {PRESENT 0 WIDTH 4}\
AWPROT {PRESENT 1 WIDTH 3} WDATA {PRESENT 1 WIDTH 32} WSTRB {PRESENT 1 WIDTH 4}\
WLAST {PRESENT 0 WIDTH 1} BRESP {PRESENT 1 WIDTH 2} ARADDR {PRESENT 1 WIDTH 32}\
...
WIDTH 3} RDATA {PRESENT 1 WIDTH 32} RRESP {PRESENT 1 WIDTH 2} RLAST {PRESENT 0\
WIDTH 1} AWID {PRESENT 0 WIDTH 0} AWREGION {PRESENT 1 WIDTH 4} AWQOS {PRESENT 1\
WIDTH 4} AWUSER {PRESENT 0 WIDTH 0} WID {PRESENT 0 WIDTH 0} WUSER {PRESENT 0\
WIDTH 0} BID {PRESENT 0 WIDTH 0} BUSER {PRESENT 0 WIDTH 0} ARID {PRESENT 0\
WIDTH 0} ARREGION {PRESENT 1 WIDTH 4} ARQOS {PRESENT 1 WIDTH 4} ARUSER {PRESENT\
0 WIDTH 0} RID {PRESENT 0 WIDTH 0} RUSER {PRESENT 0 WIDTH 0}} MODE slave}}\
IPI_PROP_COUNT 0}\
   CONFIG.GUI_INTERFACE_NAME {CNTMOD_B2R} \
  ...
  connect_bd_intf_net -intf_net dfx_controller_0_M_AXI_MEM [get_bd_intf_pins dfx_controller_0/M_AXI_MEM] [get_bd_intf_pins smartconnect_4/S00_AXI]
connect_bd_intf_net -intf_net [get_bd_intf_nets dfx_controller_0_M_AXI_MEM] [get_bd_intf_pins dfx_controller_0/M_AXI_MEM] [get_bd_intf_pins ila_0/SLOT_0_AXI]
  connect_bd_intf_net -intf_net dfx_decoupler_0_rp_CNTMOD_B2R [get_bd_intf_ports rp_CNTMOD_B2R] [get_bd_intf_pins dfx_decoupler_0/rp_CNTMOD_B2R]
  connect_bd_intf_net -intf_net ila_0_TRIG_OUT [get_bd_intf_pins ila_0/TRIG_OUT] [get_bd_intf_pins ila_1/TRIG_IN]
  ...
  connect_bd_intf_net -intf_net smartconnect_0_M00_AXI [get_bd_intf_pins dfx_decoupler_0/s_CNTMOD_B2R] [get_bd_intf_pins smartconnect_0/M00_AXI]
  connect_bd_intf_net -intf_net smartconnect_0_M01_AXI [get_bd_intf_pins dfx_controller_0/s_axi_reg] [get_bd_intf_pins smartconnect_0/M01_AXI]
  connect_bd_intf_net -intf_net smartconnect_0_M02_AXI [get_bd_intf_pins smartconnect_0/M02_AXI] [get_bd_intf_pins smartconnect_1/S01_AXI]
  connect_bd_intf_net -intf_net smartconnect_0_M03_AXI [get_bd_intf_pins smartconnect_0/M03_AXI] [get_bd_intf_pins smartconnect_4/S01_AXI]
  connect_bd_intf_net -intf_net smartconnect_1_M00_AXI [get_bd_intf_pins mdm_1/S_AXI] [get_bd_intf_pins smartconnect_1/M00_AXI]
  connect_bd_intf_net -intf_net smartconnect_4_M00_AXI [get_bd_intf_pins processing_system7_0/S_AXI_HP0] [get_bd_intf_pins smartconnect_4/M00_AXI]

  # Create port connections
  connect_bd_net -net ICAP_DBG_CSIB_1 [get_bd_ports ICAP_DBG_CSIB] [get_bd_pins ila_1/probe2]
  connect_bd_net -net ICAP_DBG_I_1 [get_bd_ports ICAP_DBG_I] [get_bd_pins ila_1/probe0]
  connect_bd_net -net ICAP_DBG_O_1 [get_bd_ports ICAP_DBG_O] [get_bd_pins ila_1/probe1]
  connect_bd_net -net ICAP_DBG_RDWRB_1 [get_bd_ports ICAP_DBG_RDWRB] [get_bd_pins ila_1/probe3]
  connect_bd_net -net VS0_trigger_1 [get_bd_ports VS0_trigger] [get_bd_pins dfx_controller_0/vsm_VS_0_hw_triggers]
  connect_bd_net -net dfx_controller_0_vsm_VS_0_event_error [get_bd_ports VS0_error] [get_bd_pins dfx_controller_0/vsm_VS_0_event_error]
  connect_bd_net -net dfx_controller_0_vsm_VS_0_rm_decouple [get_bd_pins dfx_controller_0/vsm_VS_0_rm_decouple] [get_bd_pins dfx_decoupler_0/decouple]
  connect_bd_net -net dfx_controller_0_vsm_VS_0_rm_reset [get_bd_ports VS0_reset] [get_bd_pins dfx_controller_0/vsm_VS_0_rm_reset]
  ...
  connect_bd_net -net microblaze_0_Clk [get_bd_ports CLK] [get_bd_pins dfx_controller_0/clk] [get_bd_pins dfx_controller_0/icap_clk] [get_bd_pins ila_0/clk] [get_bd_pins ila_1/clk] [get_bd_pins mdm_1/S_AXI_ACLK] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk] [get_bd_pins smartconnect_0/aclk] [get_bd_pins smartconnect_1/aclk] [get_bd_pins smartconnect_4/aclk]
  ...
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins dfx_controller_0/icap_reset] [get_bd_pins dfx_controller_0/reset] [get_bd_pins mdm_1/S_AXI_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn] [get_bd_pins smartconnect_0/aresetn] [get_bd_pins smartconnect_1/aresetn] [get_bd_pins smartconnect_4/aresetn]
  ...
  assign_bd_address -offset 0x62000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs dfx_controller_0/s_axi_reg/Reg] -force
  ...
  assign_bd_address -offset 0x20000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs rp_CNTMOD_B2R/Reg] -force
  ...
  exclude_bd_addr_seg -offset 0x20010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces dfx_controller_0/Data] [get_bd_addr_segs dfx_controller_0/s_axi_reg/Reg]
